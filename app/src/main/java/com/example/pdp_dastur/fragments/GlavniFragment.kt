...
import com.example.pdp_dastur.databinding.FragmentGlavniBinding
...
class GlavniFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.kurs.setOnClickListener {
            var bundle = Bundle()
            bundle.putString("kurs","kurs")
            findNavController().navigate(R.id.kursFragment,bundle)
        }

        binding.guruh.setOnClickListener {
            var bundle = Bundle()
            bundle.putString("guruh","guruh")
            findNavController().navigate(R.id.kursFragment,bundle)
        }

        binding.mentor.setOnClickListener {
            var bundle = Bundle()
            bundle.putString("mentor","mentor")
            findNavController().navigate(R.id.kursFragment,bundle)
        }
